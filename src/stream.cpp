...
#pragma pack(pop)
  ...
  struct session_t {
    ...
    struct {
      ...
      safe::mail_raw_t::event_t<video::bitrate_request_t> bitrate_events;  ///< Acknowledged live bitrate requests.
    ...
    struct {
      ...
      safe::mail_raw_t::event_t<video::bitrate_result_t> bitrate_results;  ///< Results sent to live bitrate clients.
      safe::mail_raw_t::event_t<remote_display::result_t> remote_display_results;  ///< Display command results.
      std::shared_ptr<std::atomic_bool> remote_display_apply_pending;  ///< In-flight display application guard.
